...
def parse():
    ...
    parser.add_argument('--save_model_path', type=str, default='../best_model_dianping/best_model', metavar='N',
                        help='the best source path')
    parser.add_argument('--train_model_weights_path', type=str, default='../train_model_weights_epochs_dianping', metavar='N',
                        help='the best source path')
